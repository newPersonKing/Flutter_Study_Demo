...
import 'package:first_flutter_app/page/order/pay_type_dialog.dart';
...
class _OrderListState extends State<OrderList> with AutomaticKeepAliveClientMixin<OrderList>{
  ...
  Widget build(BuildContext context) {
    ...
    return NotificationListener(
      onNotification: (ScrollNotification note){/*用来监听滑动*/
      ...
      child: RefreshIndicator(
        ...
        displacement: 120.0, /// 默认40， 多添加的80为Header高度  因为设置了SliverPersistentHeader
        child: CustomScrollView(
          /// 这里指定controller可以与外层NestedScrollView的滚动分离，避免一处滑动，5个Tab中的列表同步滑动。
          controller: _index != widget.tabIndex ? _controller : null, /*这里设置不设置的 好像没什么影响 反正也没有用_controller 做操作*/
  ...
  void _showCallPhoneDialog(String phone){
    showDialog(
        context: context,
        barrierDismissible: false,/*控制点击外部 是否会消失*/
        builder: (BuildContext context) {
          return AlertDialog(
            title: const Text('提示'),
