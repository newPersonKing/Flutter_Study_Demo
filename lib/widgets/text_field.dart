  ...
  Future _getVCode() async {
    ...
    if (isSuccess != null && isSuccess){
      ...
      _subscription = Observable.periodic(Duration(seconds: 1), (i) => i).take(second).listen((i){
        s = second - i - 1;
        _isClick = s < 1;
        streamController.sink.add(1);/*用stream 可以 只局部刷新*/
      });
    }
  }
    ...
    return Stack(
      ...
      children: <Widget>[
        TextField(
          ...
          obscureText: widget.isInputPwd ? !_isShowPwd : false,/*是否模糊文字*/
          autofocus: widget.autoFocus,/*获取焦点*/
